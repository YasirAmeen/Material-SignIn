...
public class largeScreenNormalRobotoRegular extends TextView {
	public largeScreenNormalRobotoRegular(Context context) {
		super(context);
		setFont();
	}
	public largeScreenNormalRobotoRegular(Context context, AttributeSet attrs) {
		super(context, attrs);
		setFont();
	}
	public largeScreenNormalRobotoRegular(Context context, AttributeSet attrs, int defStyle) {
